...
messages = {"bridge":('You are now in the bridge', 'There is a paper clip and toothbrush and stapler'),
            ...
            "greenB1":("the green light doesn't actually seem to be a button", "huh"),
            "blueB1":('You pressed the blue button, but nothing happens'),
            ...
            "20":("75 percent oxygen left",""),
            "30":("50 percent oxygen leftt",""),
            "40":("25 percent oxygen left",""),
            "60":("0 percent oxygen left",""),
